...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('reports.inventory', ['export' => 'csv']) }}" 
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $summary['total_products'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">Rs. {{ number_format($summary['total_value'], 2) }}</p>
                </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-right text-gray-500">{{ $product->min_stock_level }}</td>
                        <td class="px-6 py-4 text-right text-gray-500">Rs. {{ number_format($product->purchase_price, 2) }}</td>
                        <td class="px-6 py-4 text-right text-gray-800">Rs. {{ number_format($product->selling_price, 2) }}</td>
