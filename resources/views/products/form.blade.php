...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-500">{{ isset($product) ? 'Update product details' : 'Add a new product to inventory' }}</p>
        </div>
    ...
    <form action="{{ isset($product) ? route('products.update', $product) : route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="unit" class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Stock Management</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" name="min_stock_level" value="{{ old('min_stock_level', $product->min_stock_level ?? 10) }}"
                                   class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                   placeholder="10">
                            <p class="mt-1 text-sm text-gray-500">You'll be alerted when stock falls below this level</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Sidebar -->
            <div class="space-y-6">
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100" x-data="imageUpload()">
                    ...
                    <div class="space-y-4">
                        ...
                        <label x-show="!imagePreview && !hasExistingImage" class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-primary-500 transition-colors">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <label class="flex items-center space-x-3">
                        ...
                        <span class="text-gray-700">Product is active</span>
                    </label>
                    <p class="mt-2 text-sm text-gray-500">Inactive products won't appear in bill creation</p>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('products.index') }}" class="block text-center w-full px-6 py-3 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors">
                        Cancel
                    </a>
                </div>
            </div>
