...
<div class="space-y-6" x-data="billForm()">
    ...
    <form action="{{ isset($bill) && !isset($isDuplicate) ? route('bills.update', $bill) : route('bills.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('bills.index') }}" class="px-6 py-3 border border-gray-200 dark:border-gray-600 text-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                Cancel
            </a>
