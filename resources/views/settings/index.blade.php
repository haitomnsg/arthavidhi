...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-gray-500">Manage your account and company settings</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
            <nav class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <a href="#company" class="flex items-center px-4 py-3 text-primary-500 bg-primary-50 border-l-4 border-primary-500">
                    <i class="fas fa-building w-5"></i>
                    <span class="ml-3">Company Profile</span>
                </a>
                <a href="#user" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 border-l-4 border-transparent hover:text-primary-500">
                    <i class="fas fa-user w-5"></i>
                    <span class="ml-3">User Account</span>
                </a>
                <a href="#billing" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 border-l-4 border-transparent hover:text-primary-500">
                    <i class="fas fa-file-invoice w-5"></i>
                    <span class="ml-3">Billing Settings</span>
                </a>
                <a href="#notifications" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 border-l-4 border-transparent hover:text-primary-500">
                    <i class="fas fa-bell w-5"></i>
                    <span class="ml-3">Notifications</span>
                </a>
                <a href="#security" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 border-l-4 border-transparent hover:text-primary-500">
        ...
        <div class="lg:col-span-3 space-y-6">
            <!-- Company Profile -->
            <div id="company" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <form action="{{ route('settings.company.update') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="shrink-0">
                            ...
                            @else
                            <div class="w-20 h-20 bg-primary-100 rounded-xl flex items-center justify-center">
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input type="file" name="logo" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-primary-50 file:text-primary-600 hover:file:bg-primary-100"/>
                            </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="2"
                                      class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ old('address', $company->address ?? '') }}</textarea>
                        </div>
                        <div>
            ...
            <!-- User Account -->
            <div id="user" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">User Account</h3>
            ...
            <!-- Billing Settings -->
            <div id="billing" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Billing Settings</h3>
                <form action="{{ route('settings.billing.update') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Bill Prefix</label>
                            <input type="text" name="bill_prefix" value="{{ old('bill_prefix', $settings->bill_prefix ?? 'INV-') }}"
                                   class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                   placeholder="INV-">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Quotation Prefix</label>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Bill Footer Text</label>
            ...
            <!-- Security -->
            <div id="security" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
