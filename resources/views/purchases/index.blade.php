        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800 dark:text-white">{{ $totalPurchases ?? 0 }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800 dark:text-white">Rs. {{ number_format($monthTotal ?? 0, 2) }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800 dark:text-white">Rs. {{ number_format($pendingPayment ?? 0, 2) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
        <form action="{{ route('purchases.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('purchases.index') }}" class="px-4 py-2 text-gray-500 hover:text-gray-700 dark:text-gray-300">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td class="px-6 py-4 text-gray-600 dark:text-gray-400">{{ $purchase->purchase_date->format('M d, Y') }}</td>
                        <td class="px-6 py-4">
                            <p class="font-medium text-gray-800 dark:text-white">{{ $purchase->supplier_name }}</p>
                            @if($purchase->supplier_phone)
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $purchase->supplier_phone }}</p>
                            @endif
                        </td>
                        <td class="px-6 py-4 text-gray-600 dark:text-gray-400">{{ $purchase->items->count() }} items</td>
                        <td class="px-6 py-4 font-semibold text-gray-800 dark:text-white">Rs. {{ number_format($purchase->total_amount, 2) }}</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('purchases.show', $purchase) }}" class="p-2 text-gray-500 hover:text-primary-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('purchases.edit', $purchase) }}" class="p-2 text-gray-500 hover:text-blue-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg" title="Edit">
