...
<div x-data="purchaseForm()" class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">{{ isset($purchase) ? 'Edit Purchase' : 'New Purchase' }}</h1>
                <p class="text-gray-500 dark:text-gray-400">{{ isset($purchase) ? 'Update purchase order details' : 'Create a new purchase order' }}</p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="supplier_name" 
                                   ...
                                   class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('supplier_name') border-red-500 @enderror"
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('purchases.index') }}" class="block w-full px-6 py-3 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-medium text-center">
                        Cancel
                    </a>
                </div>
            </div>
