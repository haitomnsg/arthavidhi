        ...
        <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col fixed h-full z-30 transition-transform duration-300"
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="<?php echo e(route('bills.index')); ?>" 
                   @click.prevent="openTab('<?php echo e(route('bills.index')); ?>', 'Find Bills', 'fa-file-invoice')"
                   class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-600 dark:text-gray-300"
                ...
                <a href="<?php echo e(route('quotations.create')); ?>" 
                   @click.prevent="openTab('<?php echo e(route('quotations.create')); ?>', 'Create Quotation', 'fa-file-alt')"
                   class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-600 dark:text-gray-300"
                ...
                <a href="<?php echo e(route('quotations.index')); ?>" 
                   @click.prevent="openTab('<?php echo e(route('quotations.index')); ?>', 'Find Quotations', 'fa-search')"
                   class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-600 dark:text-gray-300"
                ...
                <a href="<?php echo e(route('reports.index')); ?>" 
                   @click.prevent="openTab('<?php echo e(route('reports.index')); ?>', 'Reports', 'fa-chart-bar')"
                   class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-600 dark:text-gray-300"
...
<?php endif; ?>
<?php /**PATH D:\billing\backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>