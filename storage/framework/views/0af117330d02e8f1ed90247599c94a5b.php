...
<?php $__env->startSection('title', isset($bill) && !isset($isDuplicate) ? 'Edit Bill' : 'Create Bill'); ?>
...
<div class="space-y-6" x-data="billForm()">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(isset($isDuplicate) ? 'Duplicate Bill' : (isset($bill) ? 'Edit Bill' : 'Create New Bill')); ?></h1>
            <p class="text-gray-500 dark:text-gray-400"><?php echo e(isset($isDuplicate) ? 'Create a new bill from existing' : (isset($bill) ? 'Update bill details' : 'Create a new sales invoice')); ?></p>
        </div>
    ...
    <form action="<?php echo e(isset($bill) && !isset($isDuplicate) ? route('bills.update', $bill) : route('bills.store')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        <?php if(isset($bill) && !isset($isDuplicate)): ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="customer_name" value="<?php echo e(old('customer_name', $duplicateFrom->customer_name ?? $bill->customer_name ?? '')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="tel" name="customer_phone" value="<?php echo e(old('customer_phone', $duplicateFrom->customer_phone ?? $bill->customer_phone ?? '')); ?>"
                           class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                           placeholder="Phone number">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Email</label>
                    <input type="email" name="customer_email" value="<?php echo e(old('customer_email', $duplicateFrom->customer_email ?? $bill->customer_email ?? '')); ?>"
                           class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    ...
                    <textarea name="customer_address" rows="2"
                              class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                              placeholder="Customer address"><?php echo e(old('customer_address', $duplicateFrom->customer_address ?? $bill->customer_address ?? '')); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <textarea name="notes" rows="4"
                          class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                          placeholder="Add any notes or terms..."><?php echo e(old('notes', $duplicateFrom->notes ?? $bill->notes ?? '')); ?></textarea>
            </div>
        ...
        <div class="flex justify-end space-x-4">
            ...
            <button type="submit" class="px-6 py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors">
                <i class="fas fa-save mr-2"></i> <?php echo e(isset($bill) && !isset($isDuplicate) ? 'Update Bill' : 'Create Bill'); ?>
