...
<div class="space-y-6" x-data="categoryManager()">
    ...
    <nav class="flex items-center text-sm text-gray-500 dark:text-gray-400 overflow-x-auto" aria-label="Breadcrumb">
        <a href="<?php echo e(route('categories.index')); ?>" 
           class="flex items-center hover:text-primary-500 transition-colors <?php echo e(!$parent ? 'text-primary-600 font-semibold' : ''); ?>">
        ...
        <?php if($parent): ?>
            <?php $__currentLoopData = $breadcrumb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($crumb->id === $parent->id): ?>
                    <span class="text-primary-600 dark:text-primary-400 font-semibold"><?php echo e($crumb->name); ?></span>
                <?php else: ?>
                    <a href="<?php echo e(route('categories.index', ['parent_id' => $crumb->id])); ?>" 
                       class="hover:text-primary-500 transition-colors whitespace-nowrap"><?php echo e($crumb->name); ?></a>
                <?php endif; ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400">
                <?php if($parent): ?>
                    Subcategories of <?php echo e($parent->name); ?> &middot; <?php echo e($levelLabels[$parent->level + 1] ?? 'Level ' . ($parent->level + 1)); ?>
        ...
        <div class="flex items-center gap-2">
            <?php if($parent): ?>
                <a href="<?php echo e($parent->parent_id ? route('categories.index', ['parent_id' => $parent->parent_id]) : route('categories.index')); ?>" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all group <?php echo e(!$cat->is_active ? 'opacity-60' : ''); ?>">
            <!-- Category Image (if exists) -->
            <?php if($cat->image): ?>
            <div class="h-32 rounded-t-xl overflow-hidden bg-gray-100 dark:bg-gray-700">
                <img src="<?php echo e($cat->image); ?>" alt="<?php echo e($cat->name); ?>" class="w-full h-full object-cover">
            </div>
            <?php endif; ?>
            ...
            <div class="p-6">
                <div class="flex items-start justify-between">
                    <div class="flex items-center space-x-4 flex-1 min-w-0">
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0
                            <?php echo e($cat->children_count > 0 ? 'bg-blue-100 dark:bg-blue-900/30' : 'bg-primary-100 dark:bg-primary-900/30'); ?>">
                        ...
                        <div class="min-w-0">
                            <h3 class="font-semibold text-gray-800 dark:text-white truncate"><?php echo e($cat->name); ?></h3>
                            <div class="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400 mt-1">
                                <span title="Direct products">
                                    <i class="fas fa-box text-xs mr-1"></i><?php echo e($cat->products_count ?? 0); ?>

                                </span>
                                <?php if($cat->children_count > 0): ?>
                                    <span title="Subcategories">
                                        <i class="fas fa-sitemap text-xs mr-1"></i><?php echo e($cat->children_count); ?>

                                    </span>
                                <?php endif; ?>
                                <?php if($cat->total_product_count > $cat->products_count): ?>
                                    <span title="Total products (including subcategories)" class="text-primary-500">
                                        <i class="fas fa-boxes-stacked text-xs mr-1"></i><?php echo e($cat->total_product_count); ?> total
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition 
                            ...
                            <?php if($cat->children_count > 0): ?>
                            <a href="<?php echo e(route('categories.index', ['parent_id' => $cat->id])); ?>" 
                               class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <i class="fas fa-folder-open mr-2 w-4"></i> View Subcategories
                            </a>
                            <?php endif; ?>
                            <button @click="openEditModal(<?php echo e(json_encode([
                                'id' => $cat->id, 
                                'name' => $cat->name, 
                            ...
                            <button @click="deleteCategory = <?php echo e(json_encode([
                                'id' => $cat->id, 
                                'name' => $cat->name, 
                ...
                <div class="flex items-center gap-2 mt-3">
                    ...
                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400">
                        <?php echo e($levelLabels[$cat->level] ?? 'Level ' . $cat->level); ?>

                    </span>
                </div>

                <?php if($cat->description): ?>
                <p class="mt-3 text-sm text-gray-600 dark:text-gray-400 line-clamp-2"><?php echo e($cat->description); ?></p>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('categories.index', ['parent_id' => $cat->id])); ?>" 
                   class="mt-4 flex items-center justify-center w-full px-4 py-2 text-sm text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 rounded-lg hover:bg-primary-100 dark:hover:bg-primary-900/30 transition-colors">
                    ...
                    Browse <?php echo e($cat->children_count); ?> subcategor<?php echo e($cat->children_count === 1 ? 'y' : 'ies'); ?>
        ...
        <div class="col-span-full">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-12 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-4">
                    <?php if($parent): ?>
                        No subcategories in <?php echo e($parent->name); ?> yet
                    <?php else: ?>
                        No categories yet
                    <?php endif; ?>
                </p>
    ...
    <div x-show="showModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <div x-show="showModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                ...
                <form :action="editMode ? '<?php echo e(url('categories')); ?>/' + category.id : '<?php echo e(route('categories.store')); ?>'" 
                        ...
                        <select name="parent_id" x-model="category.parent_id"
                            ...
                            <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>">
                                    <?php echo e(str_repeat('— ', $cat->level)); ?><?php echo e($cat->name); ?>
    ...
    <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div x-show="showDeleteModal" x-transition class="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
                ...
                <form :action="'<?php echo e(url('categories')); ?>/' + deleteCategory?.id" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
function categoryManager() {
    return {
        ...
        category: {
            ...
            name: '',
            description: '',
            parent_id: '<?php echo e($parent ? $parent->id : ''); ?>',
            is_active: true,
            sort_order: 0,
        },
        deleteCategory: null,
