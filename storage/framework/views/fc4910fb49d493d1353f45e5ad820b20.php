...
<div x-data="{ open: false, billId: null, billNumber: '' }" 
     @open-cancel-modal.window="open = true; billId = $event.detail.billId; billNumber = $event.detail.billNumber; $nextTick(() => { document.getElementById('cancelBillForm').action = '<?php echo e(url('bills')); ?>/' + billId + '/cancel'; })"
     x-show="open" 
     x-cloak
