...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="date-range">Generated: <?php echo e(now()->format('M d, Y')); ?></div>
        </div>
        ...
        <table class="summary-table">
            <tr>
                <td>
                    ...
                    <div class="summary-value"><?php echo e($summary['total_products']); ?></div>
                </td>
                <td>
                    <div class="summary-label">Total Stock Value</div>
                    <div class="summary-value">Rs. <?php echo e(number_format($summary['total_value'], 2)); ?></div>
                </td>
                <td>
                    <div class="summary-label">Low Stock Items</div>
                    <div class="summary-value" style="color: #92400e;"><?php echo e($summary['low_stock']); ?></div>
                </td>
                <td>
                    <div class="summary-label">Out of Stock</div>
                    <div class="summary-value" style="color: #991b1b;"><?php echo e($summary['out_of_stock']); ?></div>
                </td>
            </tr>
        </table>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><?php echo e($product->stock_quantity); ?></td>
                    <td class="text-right"><?php echo e($product->min_stock_level); ?></td>
                    <td class="text-right"><?php echo e(number_format($product->purchase_price, 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($product->selling_price, 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($product->stock_quantity * $product->purchase_price, 2)); ?></td>
                    <td class="text-center <?php echo e($statusClass); ?>"><?php echo e($status); ?></td>
                </tr>
            ...
            <tfoot>
                <tr class="total-row">
                    ...
                    <td class="text-right font-bold">Rs. <?php echo e(number_format($products->sum(fn($p) => $p->stock_quantity * $p->purchase_price), 2)); ?></td>
                    <td></td>
                </tr>
            </tfoot>
            <?php endif; ?>
...
<?php /**PATH D:\billing\resources\views\pdf\inventory-report.blade.php ENDPATH**/ ?>