...
<div class="space-y-6" x-data="billForm()">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800"><?php echo e(isset($bill) ? 'Edit Bill' : 'Create New Bill'); ?></h1>
            <p class="text-gray-500"><?php echo e(isset($bill) ? 'Update bill details' : 'Create a new sales invoice'); ?></p>
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex justify-end space-x-4">
            <a href="<?php echo e(route('bills.index')); ?>" class="px-6 py-3 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors">
                Cancel
            </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\backend\resources\views/bills/form.blade.php ENDPATH**/ ?>