        ...
        <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col fixed h-full z-30 transition-transform duration-300"
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="<?php echo e(route('sms.index')); ?>" 
                   @click.prevent="openTab('<?php echo e(route('sms.index')); ?>', 'SMS Messages', 'fa-sms')"
                   class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-600 dark:text-gray-300"
                   :class="{ 'active': isTabActive('<?php echo e(route('sms.index')); ?>') }">
                    <i class="fas fa-sms w-5"></i>
                    <span>SMS Messages</span>
                </a>
                <a href="<?php echo e(route('crm.index')); ?>" 
                   @click.prevent="openTab('<?php echo e(route('crm.index')); ?>', 'CRM', 'fa-handshake')"
                   class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-600 dark:text-gray-300"
                   :class="{ 'active': isTabActive('<?php echo e(route('crm.index')); ?>') }">
