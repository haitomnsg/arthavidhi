...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo e(route('reports.tax.excel', ['start_date' => request('start_date'), 'end_date' => request('end_date')])); ?>" 
               class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                <i class="fas fa-file-excel mr-2"></i> Excel
            </a>
            <a href="<?php echo e(route('reports.tax.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')])); ?>" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($summary['net_tax'] >= 0 ? 'Payable' : 'Credit'); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">Rs. <?php echo e(number_format($summary['taxable_value'], 2)); ?></p>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tr>
                            <td class="px-6 py-4 font-medium text-gray-800 dark:text-white"><?php echo e($rate); ?>%</td>
                            <td class="px-6 py-4 text-right text-gray-600 dark:text-gray-400">Rs. <?php echo e(number_format($data['taxable'], 2)); ?></td>
                            <td class="px-6 py-4 text-right text-gray-600 dark:text-gray-400">Rs. <?php echo e(number_format($data['cgst'] + $data['sgst'], 2)); ?></td>
                            <td class="px-6 py-4 text-right font-medium text-gray-800 dark:text-white">Rs. <?php echo e(number_format($data['total'], 2)); ?></td>
                        </tr>
                    ...
                    <tfoot class="bg-green-50 dark:bg-green-900/20 font-medium dark:text-white">
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right text-green-800">Rs. <?php echo e(number_format(collect($outputTaxBreakdown)->sum('cgst') + collect($outputTaxBreakdown)->sum('sgst'), 2)); ?></td>
                ...
                <table class="w-full">
                    ...
                    <tfoot class="bg-red-50 dark:bg-red-900/20 font-medium dark:text-white">
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right text-red-800">Rs. <?php echo e(number_format(collect($inputTaxBreakdown)->sum('cgst') + collect($inputTaxBreakdown)->sum('sgst'), 2)); ?></td>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        ...
        <div class="space-y-4 max-w-md">
            ...
            <div class="flex justify-between items-center py-4 <?php echo e($summary['net_tax'] >= 0 ? 'bg-orange-50' : 'bg-blue-50 dark:bg-blue-900/20'); ?> -mx-6 px-6 rounded-lg">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <td class="px-6 py-4 font-medium text-gray-800 dark:text-white"><?php echo e($hsn->hsn_code ?: 'N/A'); ?></td>
                        <td class="px-6 py-4 text-gray-600 dark:text-gray-400"><?php echo e(\Illuminate\Support\Str::limit($hsn->description, 30)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-600 dark:text-gray-400"><?php echo e(number_format($hsn->quantity, 2)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-800 dark:text-white">Rs. <?php echo e(number_format($hsn->taxable_value, 2)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-600 dark:text-gray-400"><?php echo e($hsn->tax_rate); ?>%</td>
                        <td class="px-6 py-4 text-right text-gray-600 dark:text-gray-400">Rs. <?php echo e(number_format($hsn->taxable_value * $hsn->tax_rate / 200, 2)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-600 dark:text-gray-400">Rs. <?php echo e(number_format($hsn->taxable_value * $hsn->tax_rate / 200, 2)); ?></td>
                        <td class="px-6 py-4 text-right font-medium text-gray-800 dark:text-white">Rs. <?php echo e(number_format($hsn->taxable_value + ($hsn->taxable_value * $hsn->tax_rate / 100), 2)); ?></td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\resources\views\reports\tax.blade.php ENDPATH**/ ?>