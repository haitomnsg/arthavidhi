        ...
        <table class="header-table" cellpadding="0" cellspacing="0">
            <tr>
                <td class="company-cell">
                    <?php if($company): ?>
                        ...
                        <div class="company-details">
                            ...
                            <?php $taxSystem = $company->settings['tax_system'] ?? null; ?>
                            <?php if($taxSystem === 'pan' && $company->panNumber): ?>
                                <br>PAN: <?php echo e($company->panNumber); ?>

                            <?php elseif($taxSystem === 'vat' && $company->vatNumber): ?>
                                <br>VAT: <?php echo e($company->vatNumber); ?>
                ...
                <td class="invoice-cell">
                    ...
                    <span class="status status-<?php echo e(strtolower($bill->payment_status)); ?>"><?php echo e(ucfirst($bill->payment_status)); ?></span>
                </td>
            </tr>
        </table>
        ...
        <table class="details-table" cellpadding="0" cellspacing="0">
            <tr>
                <td class="details-left">
                    ...
                    <div class="info-box">
                        <div class="client-name"><?php echo e($bill->customer_name); ?></div>
                        <?php if($bill->customer_address): ?><div class="info-row"><?php echo e($bill->customer_address); ?></div><?php endif; ?>
                        <?php if($bill->customer_phone): ?><div class="info-row">Phone: <?php echo e($bill->customer_phone); ?></div><?php endif; ?>
                        <?php if($bill->customer_email): ?><div class="info-row">Email: <?php echo e($bill->customer_email); ?></div><?php endif; ?>
                    </div>
                </td>
                <td class="details-right">
                    <div class="section-title">Invoice Details</div>
                    <div class="info-box">
                        <div class="info-row"><span class="info-label">Invoice Date:</span> <?php echo e($bill->bill_date->format('d M, Y')); ?></div>
                        <?php if($bill->due_date): ?>
                        <div class="info-row"><span class="info-label">Due Date:</span> <?php echo e($bill->due_date->format('d M, Y')); ?></div>
                        <?php endif; ?>
                        <div class="info-row"><span class="info-label">Invoice #:</span> <?php echo e($bill->bill_number); ?></div>
                    </div>
                </td>
            </tr>
        </table>
                ...
                <td class="totals-cell">
                    <table class="totals-table" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="value">Rs. <?php echo e(number_format($bill->subtotal, 2)); ?></td>
                        </tr>
                        <?php if($bill->discount_amount > 0): ?>
                        <tr>
                            <td class="label">Discount:</td>
                            <td class="value">-Rs. <?php echo e(number_format($bill->discount_amount, 2)); ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php if($bill->tax_amount > 0): ?>
                        <tr>
                            <td class="label"><?php echo e(($company->settings['tax_system'] ?? '') === 'vat' ? 'VAT (13%):' : 'Tax:'); ?></td>
                            <td class="value">Rs. <?php echo e(number_format($bill->tax_amount, 2)); ?></td>
                        </tr>
                        <?php endif; ?>
                        <tr class="grand-total">
                            <td class="label">Total:</td>
                            <td class="value">Rs. <?php echo e(number_format($bill->total_amount, 2)); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
...
<?php /**PATH D:\billing\resources\views\pdf\bill.blade.php ENDPATH**/ ?>