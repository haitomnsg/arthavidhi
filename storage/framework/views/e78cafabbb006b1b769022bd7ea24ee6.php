    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <img src="<?php echo e(\Storage::url($employee->photo)); ?>" alt="<?php echo e($employee->name); ?>" class="w-16 h-16 rounded-full object-cover border-2 border-primary-200 dark:border-primary-800">
                <?php else: ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <img src="<?php echo e(\Storage::url($employee->citizenship_front)); ?>" alt="Citizenship Front" class="w-full h-40 object-cover rounded-lg border border-gray-200 dark:border-gray-600 cursor-pointer" onclick="window.open(this.src)">
                    </div>
                    <?php endif; ?>
                    <?php if($employee->citizenship_back): ?>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">Citizenship (Back)</p>
                        <img src="<?php echo e(\Storage::url($employee->citizenship_back)); ?>" alt="Citizenship Back" class="w-full h-40 object-cover rounded-lg border border-gray-200 dark:border-gray-600 cursor-pointer" onclick="window.open(this.src)">
                    </div>
                    <?php endif; ?>
                    <?php if($employee->pan_card_image): ?>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">PAN Card</p>
                        <img src="<?php echo e(\Storage::url($employee->pan_card_image)); ?>" alt="PAN Card" class="w-full h-40 object-cover rounded-lg border border-gray-200 dark:border-gray-600 cursor-pointer" onclick="window.open(this.src)">
                    </div>
                    <?php endif; ?>
                </div>
            </div>
