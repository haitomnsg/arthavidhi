...
function receiptUpload() {
    return {
        receiptPreview: null,
        hasExistingReceipt: <?php echo e(isset($expense) && $expense->receipt ? 'true' : 'false'); ?>,
        existingReceipt: '<?php echo e(isset($expense) && $expense->receipt ? \Storage::url($expense->receipt) : ""); ?>',
        isPdf: <?php echo e(isset($expense) && $expense->receipt && str_ends_with($expense->receipt, '.pdf') ? 'true' : 'false'); ?>,
