        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800"><?php echo e($totalProducts ?? 0); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800"><?php echo e($inStock ?? 0); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800"><?php echo e($lowStock ?? 0); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800"><?php echo e($outOfStock ?? 0); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <form action="<?php echo e(route('products.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="px-4 py-2 text-gray-500 hover:text-gray-700">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 truncate max-w-xs"><?php echo e($product->description); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-gray-600"><?php echo e($product->sku); ?></td>
                        <td class="px-6 py-4">
                            <?php if($product->category): ?>
                            <span class="px-2 py-1 bg-gray-100 text-gray-600 rounded-full text-sm"><?php echo e($product->category->name); ?></span>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4">
                            <div>
                                <p class="font-semibold text-gray-800">Rs. <?php echo e(number_format($product->selling_price, 2)); ?></p>
                                <p class="text-sm text-gray-500">Cost: Rs. <?php echo e(number_format($product->purchase_price, 2)); ?></p>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-2">
                                <a href="<?php echo e(route('products.show', $product)); ?>" class="p-2 text-gray-500 hover:text-primary-500 hover:bg-gray-100 rounded-lg" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('products.edit', $product)); ?>" class="p-2 text-gray-500 hover:text-blue-500 hover:bg-gray-100 rounded-lg" title="Edit">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\backend\resources\views/products/index.blade.php ENDPATH**/ ?>