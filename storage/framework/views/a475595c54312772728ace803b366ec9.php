    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <form action="<?php echo e(route('bills.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('bills.index')); ?>" class="px-4 py-2 text-gray-500 hover:text-gray-700">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-gray-600"><?php echo e($bill->bill_date->format('M d, Y')); ?></td>
                        <td class="px-6 py-4">
                            <div>
                                <p class="font-medium text-gray-800"><?php echo e($bill->customer_name); ?></p>
                                <?php if($bill->customer_phone): ?>
                                <p class="text-sm text-gray-500"><?php echo e($bill->customer_phone); ?></p>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-gray-600"><?php echo e($bill->items->count()); ?> items</td>
                        <td class="px-6 py-4 font-semibold text-gray-800">Rs. <?php echo e(number_format($bill->total_amount, 2)); ?></td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-2">
                                <a href="<?php echo e(route('bills.show', $bill)); ?>" class="p-2 text-gray-500 hover:text-primary-500 hover:bg-gray-100 rounded-lg" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('bills.edit', $bill)); ?>" class="p-2 text-gray-500 hover:text-blue-500 hover:bg-gray-100 rounded-lg" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="<?php echo e(route('bills.pdf', $bill)); ?>" class="p-2 text-gray-500 hover:text-green-500 hover:bg-gray-100 rounded-lg" title="Download PDF" target="_blank">
                                    <i class="fas fa-file-pdf"></i>
                                </a>
                                <form action="<?php echo e(route('bills.destroy', $bill)); ?>" method="POST" class="inline" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\backend\resources\views/bills/index.blade.php ENDPATH**/ ?>