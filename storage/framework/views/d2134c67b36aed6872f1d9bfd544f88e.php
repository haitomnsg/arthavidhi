...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $employee->photo)); ?>" alt="Employee Photo" class="w-24 h-24 rounded-lg object-cover border border-gray-200 dark:border-gray-600">
                            </div>
                            <?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $employee->citizenship_front)); ?>" alt="Citizenship Front" class="w-32 h-20 rounded-lg object-cover border border-gray-200 dark:border-gray-600">
                            </div>
                            <?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $employee->citizenship_back)); ?>" alt="Citizenship Back" class="w-32 h-20 rounded-lg object-cover border border-gray-200 dark:border-gray-600">
                            </div>
                            <?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $employee->pan_card_image)); ?>" alt="PAN Card" class="w-32 h-20 rounded-lg object-cover border border-gray-200 dark:border-gray-600">
                            </div>
                            <?php endif; ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
                    <?php if(isset($employee) && $employee->photo): ?>
                    <img src="<?php echo e(asset('storage/' . $employee->photo)); ?>" alt="<?php echo e($employee->name); ?>" class="w-32 h-32 rounded-full object-cover mx-auto border-4 border-primary-100 dark:border-primary-900/30">
                    <?php else: ?>
