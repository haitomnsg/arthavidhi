...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo e(route('reports.sales', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'export' => 'csv'])); ?>" 
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">Rs. <?php echo e(number_format($summary['total_sales'], 2)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($summary['total_bills']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">Rs. <?php echo e(number_format($summary['total_tax'], 2)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">Rs. <?php echo e(number_format($summary['avg_bill_value'], 2)); ?></p>
                </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-gray-500"><?php echo e($bill->bill_date->format('M d, Y')); ?></td>
                        <td class="px-6 py-4 text-gray-800"><?php echo e($bill->customer_name); ?></td>
                        <td class="px-6 py-4 text-right text-gray-800">Rs. <?php echo e(number_format($bill->subtotal, 2)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-500">Rs. <?php echo e(number_format($bill->tax_amount, 2)); ?></td>
                        <td class="px-6 py-4 text-right font-medium text-gray-800">Rs. <?php echo e(number_format($bill->total, 2)); ?></td>
                        <td class="px-6 py-4">
                            <span class="px-2 py-1 text-xs font-medium rounded-full 
                                <?php echo e($bill->payment_status === 'paid' ? 'bg-green-100 text-green-700' : ''); ?>

                                <?php echo e($bill->payment_status === 'partial' ? 'bg-yellow-100 text-yellow-700' : ''); ?>

                                <?php echo e($bill->payment_status === 'unpaid' ? 'bg-red-100 text-red-700' : ''); ?>">
                ...
                <tfoot class="bg-gray-50 font-medium">
                    <tr>
                        ...
                        <td class="px-6 py-4 text-right text-gray-800">Rs. <?php echo e(number_format($bills->sum('subtotal'), 2)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-800">Rs. <?php echo e(number_format($bills->sum('tax_amount'), 2)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-800">Rs. <?php echo e(number_format($bills->sum('total'), 2)); ?></td>
                        <td></td>
                    </tr>
                </tfoot>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\backend\resources\views/reports/sales.blade.php ENDPATH**/ ?>