...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo e(route('reports.inventory.excel')); ?>" 
               class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                <i class="fas fa-file-excel mr-2"></i> Excel
            </a>
            <a href="<?php echo e(route('reports.inventory.pdf')); ?>" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($summary['total_products']); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">Rs. <?php echo e(number_format($summary['total_value'], 2)); ?></p>
                </div>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <?php endif; ?>
                                <span class="font-medium text-gray-800 dark:text-white"><?php echo e($product->name); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-gray-500 dark:text-gray-400"><?php echo e($product->sku); ?></td>
                        <td class="px-6 py-4 text-gray-500 dark:text-gray-400"><?php echo e($product->category->name ?? '-'); ?></td>
                        ...
                        <td class="px-6 py-4 text-right text-gray-500 dark:text-gray-400"><?php echo e($product->min_stock_level); ?></td>
                        <td class="px-6 py-4 text-right text-gray-500 dark:text-gray-400">Rs. <?php echo e(number_format($product->purchase_price, 2)); ?></td>
                        <td class="px-6 py-4 text-right text-gray-800 dark:text-white">Rs. <?php echo e(number_format($product->selling_price, 2)); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\resources\views\reports\inventory.blade.php ENDPATH**/ ?>