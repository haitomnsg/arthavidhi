...
<?php $__env->startSection('title', 'Employee Report'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo e(route('reports.employees.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')])); ?>" 
               class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
                <i class="fas fa-file-pdf mr-2"></i> PDF
            </a>
            <a href="<?php echo e(route('reports.employees.excel', ['department_id' => request('department_id'), 'status' => request('status'), 'month' => request('month')])); ?>" 
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
        <form action="<?php echo e(route('reports.employees')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('reports.employees')); ?>" class="px-4 py-2 text-gray-500 hover:text-gray-700 dark:text-gray-300">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($summary['total_employees']); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600"><?php echo e($summary['active_employees']); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-600"><?php echo e($summary['inactive_employees']); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">Rs. <?php echo e(number_format($summary['total_monthly_salary'], 0)); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($summary['avg_attendance']); ?>%</p>
                </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($employee->email); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-gray-600 dark:text-gray-400"><?php echo e($employee->departmentModel->name ?? 'N/A'); ?></td>
                        <td class="px-6 py-4 text-gray-600 dark:text-gray-400"><?php echo e($employee->position ?? $employee->designation ?? 'N/A'); ?></td>
                        <td class="px-6 py-4 text-right font-medium text-gray-800 dark:text-white">
                            Rs. <?php echo e(number_format($employee->salary, 0)); ?>
                        ...
                        <td class="px-6 py-4 text-center font-medium text-green-600"><?php echo e($employee->present_days ?? 0); ?></td>
                        <td class="px-6 py-4 text-center font-medium text-red-600"><?php echo e($employee->absent_days ?? 0); ?></td>
                        <td class="px-6 py-4 text-gray-500 text-sm">
                            <?php echo e($employee->joining_date ? $employee->joining_date->format('M d, Y') : ($employee->hire_date ? $employee->hire_date->format('M d, Y') : 'N/A')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(deptCtx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($deptChartData['labels'], 15, 512) ?>,
            datasets: [{
                label: 'Employees',
                data: <?php echo json_encode($deptChartData['values'], 15, 512) ?>,
    ...
    new Chart(attCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: <?php echo json_encode([$attendanceData['present'], $attendanceData['absent'], $attendanceData['leave']]) ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\resources\views\reports\employees.blade.php ENDPATH**/ ?>