...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(isset($product) ? 'Edit Product' : 'Add New Product'); ?></h1>
            <p class="text-gray-500 dark:text-gray-400"><?php echo e(isset($product) ? 'Update product details' : 'Add a new product to inventory'); ?></p>
        </div>
        <a href="<?php echo e(route('products.index')); ?>" class="px-4 py-2 text-gray-600 hover:text-gray-800 dark:text-white">
            <i class="fas fa-arrow-left mr-2"></i> Back to Products
        </a>
    </div>

    <form action="<?php echo e(isset($product) ? route('products.update', $product) : route('products.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="unit" class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                                ...
                                <option value="g" <?php echo e(old('unit', $product->unit ?? '') === 'g' ? 'selected' : ''); ?>>Gram (g)</option>
                                <option value="l" <?php echo e(old('unit', $product->unit ?? '') === 'l' ? 'selected' : ''); ?>>Liter (L)</option>
                                <option value="ml" <?php echo e(old('unit', $product->unit ?? '') === 'ml' ? 'selected' : ''); ?>>Milliliter (ml)</option>
                                <option value="m" <?php echo e(old('unit', $product->unit ?? '') === 'm' ? 'selected' : ''); ?>>Meter (m)</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description-editor"><?php echo old('description', $product->description ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="purchase_price" value="<?php echo e(old('purchase_price', $product->purchase_price ?? '')); ?>" required step="0.01"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2 text-gray-500 dark:text-gray-400">Rs</span>
                                <input type="number" name="selling_price" value="<?php echo e(old('selling_price', $product->selling_price ?? '')); ?>" required step="0.01"
                                       class="w-full pl-8 pr-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                       placeholder="0.00">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="tax_rate" value="<?php echo e(old('tax_rate', $product->tax_rate ?? 0)); ?>" step="0.01"
                                   class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                   placeholder="0">
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="stock_quantity" value="<?php echo e(old('stock_quantity', $product->stock_quantity ?? 0)); ?>"
                                   class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                   placeholder="0">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Minimum Stock Level</label>
                            <input type="number" name="min_stock_level" value="<?php echo e(old('min_stock_level', $product->min_stock_level ?? 10)); ?>"
                                   class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                   placeholder="10">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-3">
                    <button type="submit" class="w-full px-6 py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors">
                        <i class="fas fa-save mr-2"></i> <?php echo e(isset($product) ? 'Update Product' : 'Save Product'); ?>

                    </button>
                    <a href="<?php echo e(route('products.index')); ?>" class="block text-center w-full px-6 py-3 border border-gray-200 dark:border-gray-600 text-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        Cancel
                    </a>
                </div>
            </div>
...
function imageUpload() {
    return {
        imagePreview: null,
        hasExistingImage: <?php echo e(isset($product) && $product->image ? 'true' : 'false'); ?>,
        existingImage: '<?php echo e(isset($product) && $product->image ? \Storage::url($product->image) : ""); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\billing\resources\views\products\form.blade.php ENDPATH**/ ?>